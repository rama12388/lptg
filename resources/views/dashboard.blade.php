				...
				<div class="sidebar-content">
					<div class="user">
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									administrator
									<span class="user-level">Geodesi Undip</span>
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-section">
							...
							<h4 class="text-section"><a href="{{route('comment.admin')}}">Comment</a></h4>
						</li>
					</ul>
				</div>
			</div>
			...
			<footer class="footer">
				<div class="container-fluid">
					...
					<div class="copyright ml-auto">
						2019 made with <i class="fa fa-heart heart text-danger"></i> by Ramadhan Susilo Utomo
					</div>			
				</div>
