    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            ...
            <div class="ml-md-auto py-2 py-md-0">
                <a href="{{route('user.datatable')}}" class="btn btn-white btn-border btn-round mr-2">Get Data</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Research Location Statistics</div>
                    </div>
                </div>
                <div class="card-body">
...
<div class="page-inner">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Research Fields</div>
                </div>
                <div class="card-body">
    ...
    <div class="row mt--2">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Research Maps</div>
                    </div>
                </div>
                <div class="card-body">
